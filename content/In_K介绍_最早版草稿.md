---
title: 关于 In_K（最早版草稿）
slug: about-origin-draft
draft: true
categories:
  - blog
tags:
summary: 最早版 In_K 介绍草稿存档
description: 最早提交版本的 In_K 介绍内容，保留为草稿存档。
...
---
In_K 的创作围绕“可运行的视觉结构”展开。作品并非固定成品，而是被编码为可以持续生成、偏移与响应现场的系统。算法、语义与身体反馈在同一时空中相互牵引，形成图像的动态秩序。

其方法横跨 vvvv、Touch Designer、Unreal、Blender 与 AIGC 工具链，实践从互动装置延伸至实时舞台视觉，持续检验技术与观念之间的张力。
