...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
  ...
  <img src="https://r2.inkx.cc/ink-pfp.jpg" alt="图片2" style="width:100%; border-radius:8px;" />
</div>
## 部分展览
...
<div style="display: flex; gap: 24px; align-items: center; margin-bottom: 32px;">
  ...
  <div style="flex: 1;">
    ...
    <a href="/project/visualshow" style="color: #007BFF; text-decoration: underline;">了解更多 →</a>
  </div>
</div>
...
<div style="display: flex; gap: 24px; align-items: center; margin-bottom: 32px;">
  ...
  <div style="flex: 1;">
    ...
    <a href="/project" style="color: #007BFF; text-decoration: underline;">了解更多 →</a>
  </div>
</div>
