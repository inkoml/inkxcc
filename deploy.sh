...
# 确保 .gitignore 中忽略 .obsidian、.DS_Store 和 deploy.log
for f in ".obsidian" ".DS_Store" "deploy.log"; do
...
############################################
# 确保 deploy.log 不影响 pull
############################################
git restore --staged deploy.log 2>/dev/null
git restore deploy.log 2>/dev/null
